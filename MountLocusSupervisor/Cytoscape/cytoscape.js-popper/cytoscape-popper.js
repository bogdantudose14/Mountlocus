(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root['cytoscapePopper'] = factory(root['Popper']);
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function createOptionsObject(target, opts) {
          var renderedDimensions = function renderedDimensions(el) {
            return el.isNode()
              ? { w: el.renderedWidth(), h: el.renderedHeight() }
              : { w: 3, h: 3 };
          };
          var renderedPosition = function renderedPosition(el) {
            return el.isNode()
              ? getRenderedCenter(el, renderedDimensions)
              : getRenderedMidpoint(el);
          };
          var popper = {};
          var cy = target.cy();
        ...
        function checkForWarning(elements) {
          ...
          if (elements.length > 1) {
            console.warn(
              'Popper.js Extension should only be used on one element.'
            );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        function getContent(target, content) {
          ...
          if (typeof content === 'function') {
            ...
            throw new Error(
              "Can not create popper from 'target' with unknown type"
            );
          }
